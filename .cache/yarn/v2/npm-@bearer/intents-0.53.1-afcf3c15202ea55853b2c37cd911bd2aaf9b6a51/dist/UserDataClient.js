...
class UserDataClient {
    ...
    updateState(referenceId, state) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.client.put(`api/v1/items/${referenceId}`, Object.assign({}, state, { ReadAllowed: true }));
    ...
    saveState(state) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.client.post(`api/v1/items`, Object.assign({}, state, { ReadAllowed: true }));
                return response.data;
            }
            catch (error) {
...
exports.default = (baseURL) => new UserDataClient(baseURL);
