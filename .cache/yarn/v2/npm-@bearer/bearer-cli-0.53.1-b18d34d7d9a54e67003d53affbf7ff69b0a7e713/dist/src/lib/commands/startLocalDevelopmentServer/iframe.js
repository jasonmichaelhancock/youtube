!(function (e) {
    ...
    function (e, r, n) {
        ...
        console.log('[BEARER]', 'Session uuid', i.Storage.cookieUserId),
            ...
            o.on(t.Events.HAS_AUTHORIZED, function (e) {
                return (console.log('[BEARER]', 'hasAuthoried?', e.data),
                    {
        ...
        'undefined' != typeof self && self,
            (e.exports = (function (e) {
                ...
                './node_modules/cross-domain-safe-weakmap/src/weakmap.js': function (e, r, n) {
                    ...
                    var o = n('./node_modules/cross-domain-utils/src/index.js'), t = n('./node_modules/cross-domain-safe-weakmap/src/native.js'), i = n('./node_modules/cross-domain-safe-weakmap/src/util.js'), s = Object.defineProperty, a = Date.now() % 1e9;
                        ...
                        return ((e.prototype._cleanupClosedWindows = function () {
                            ...
                            (e.prototype.set = function (e, r) {
                                ...
                                if (this.isSafeToReadWrite(e)) {
                                    var o = this.name, t = e[o];
                                    t && t[0] === e ? (t[1] = r) : s(e, o, { value: [e, r], writable: !0 });
                                }
                                else {
                                    this._cleanupClosedWindows();
                                    var a = this.keys, c = this.values, u = (0, i.safeIndexOf)(a, e);
                            ...
                            (e.prototype.get = function (e) {
                                ...
                                if (!this.isSafeToReadWrite(e)) {
                                    this._cleanupClosedWindows();
                                    var n = this.keys, o = (0, i.safeIndexOf)(n, e);
                                    if (-1 === o)
                                        return;
                            ...
                            (e.prototype.delete = function (e) {
                                ...
                                if (this.isSafeToReadWrite(e)) {
                                    ...
                                    this._cleanupClosedWindows();
                                    var o = this.keys, t = (0, i.safeIndexOf)(o, e);
                ...
                './node_modules/cross-domain-utils/src/utils.js': function (e, r, n) {
                    ...
                    (r.__esModule = !0),
                        ...
                        (r.onCloseWindow = function (e, r) {
                            var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 1e3, o = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : 1 / 0, t = void 0;
                            return ((function i() {
                                if (O(e))
                    ...
                    var o = n('./node_modules/cross-domain-utils/src/util.js'), t = {
                        MOCK_PROTOCOL: 'mock:',
                        FILE_PROTOCOL: 'file:',
                    ...
                    function h(e) {
                        var r = [], n = _(e), o = Array.isArray(n), t = 0;
                        for (n = o ? n : n[Symbol.iterator]();;) {
                            ...
                            var s = i;
                            r.push(s);
                            var a = h(s), c = Array.isArray(a), u = 0;
                    ...
                    function w(e) {
                        if (e) {
                            ...
                            if (a(e) === e)
                                return e;
                            try {
                                if (g(window, e) && window.top)
                                    return window.top;
                            }
                            catch (e) { }
                            try {
                                if (g(e, window) && window.top)
                                    return window.top;
                            }
                            catch (e) { }
                            var r = h(e), n = Array.isArray(r), o = 0;
                    ...
                    function b(e, r) {
                        var n = _(e), o = n, t = Array.isArray(o), i = 0;
                    ...
                    function T(e, r) {
                        ...
                        if (n)
                            return n;
                        var o = _(e), t = Array.isArray(o), i = 0;
                        for (o = t ? o : o[Symbol.iterator]();;) {
                            var s;
                            if (t) {
                                if (i >= o.length)
                ...
                './node_modules/webpack/buildin/global.js': function (e, r, n) {
                    'use strict';
                    var o, t = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
                        ? function (e) {
                            return typeof e;
                        }
                        : function (e) {
                ...
                './node_modules/zalgo-promise/src/exceptions.js': function (e, r, n) {
                    ...
                    (r.__esModule = !0),
                        ...
                        (r.onPossiblyUnhandledException = function (e) {
                            return ((0, o.getGlobal)().possiblyUnhandledPromiseHandlers.push(e),
                                {
                                    cancel: function () {
                                        ;
                                        (0, o.getGlobal)().possiblyUnhandledPromiseHandlers.splice((0, o.getGlobal)().possiblyUnhandledPromiseHandlers.indexOf(e), 1);
                                    }
                                });
                        });
                    ...
                    (function (e) {
                        ...
                        (r.__esModule = !0),
                            (r.getGlobal = function () {
                                ...
                                return ((n.flushPromises = n.flushPromises || []),
                ...
                './node_modules/zalgo-promise/src/promise.js': function (e, r, n) {
                    ...
                    var o = n('./node_modules/zalgo-promise/src/utils.js'), t = n('./node_modules/zalgo-promise/src/exceptions.js'), i = n('./node_modules/zalgo-promise/src/global.js'), s = (function () {
                        function e(r) {
                            var n = this;
                            if (((function (e, r) {
                                if (!(e instanceof r))
                                ...
                                (this.handlers = []),
                                r)) {
                                var o = void 0, t = void 0, i = !1, s = !1, a = !1;
                                try {
                                    r(function (e) {
                        ...
                        return ((e.prototype.resolve = function (e) {
                            ...
                            (e.prototype.dispatch = function () {
                                var r = this, n = this.dispatching, t = this.resolved, s = this.rejected, a = this.handlers;
                                if (!n && (t || s)) {
                                    ;
                                    (this.dispatching = !0), ((0, i.getGlobal)().activeCount += 1);
                                    for (var c = function (n) {
                                        var i = a[n], c = i.onSuccess, u = i.onError, l = i.promise, d = void 0;
                                        if (t)
                                            try {
                            ...
                            (e.hash = function (r) {
                                var n = {};
                                return e
                                    .all(Object.keys(r).map(function (o) {
                            ...
                            (e.flush = function () {
                                var r = new e();
                                return ((0, i.getGlobal)().flushPromises.push(r), 0 === (0, i.getGlobal)().activeCount && e.flushQueue(), r);
                            }),
                            (e.flushQueue = function () {
                                var e = (0, i.getGlobal)().flushPromises;
                                (0, i.getGlobal)().flushPromises = [];
                                var r = e, n = Array.isArray(r), o = 0;
                                for (r = n ? r : r[Symbol.iterator]();;) {
                                    var t;
                                    if (n) {
                                        if (o >= r.length)
                ...
                './src/conf/config.js': function (e, r, n) {
                    ...
                    var o, t = n('./src/conf/constants.js'), i = (r.CONFIG = {
                ...
                './src/drivers/listeners.js': function (e, r, n) {
                    ...
                    (r.__esModule = !0),
                        ...
                        (r.addRequestListener = function e(r, n) {
                            var t = r.name, l = r.win, d = r.domain;
                            ...
                            if (((l && l !== a.CONSTANTS.WILDCARD) || (l = i.global.WINDOW_WILDCARD),
                                (d = d || a.CONSTANTS.WILDCARD),
                                b))
                                throw l && d
                                    ? new Error('Request listener already exists for ' +
                                        t +
                                        ' on domain ' +
                                        d.toString() +
                                        ' for ' +
                            ...
                            var T = i.global.requestListeners, A = T[t];
                            A || ((A = new o.WeakMap()), (T[t] = A));
                            var j = A.get(l);
                            j || ((j = {}), A.set(l, j));
                            var P = d.toString(), N = j[c], R = void 0;
                            return ((0, s.isRegex)(d)
                    ...
                    var o = n('./node_modules/cross-domain-safe-weakmap/src/index.js'), t = n('./node_modules/cross-domain-utils/src/index.js'), i = n('./src/global.js'), s = n('./src/lib/index.js'), a = n('./src/conf/index.js');
                    ...
                    function u(e) {
                        var r = e.name, n = e.win, o = e.domain;
                                ...
                                if (f) {
                                    if (o && 'string' == typeof o) {
                                        if (f[o])
                                            return f[o];
                                        if (f[c]) {
                                            var m = f[c], p = Array.isArray(m), g = 0;
                                            for (m = p ? m : m[Symbol.iterator]();;) {
                                                ...
                                                var h = _, w = h.regex, S = h.listener;
                                                if ((0, t.matchDomain)(w, o))
                                                    return S;
                                            }
                                        }
                                    }
                ...
                './src/drivers/receive/index.js': function (e, r, n) {
                    ...
                    var t = n('./node_modules/cross-domain-utils/src/index.js'), i = n('./src/conf/index.js'), s = n('./src/lib/index.js'), a = n('./src/global.js'), c = n('./src/drivers/receive/types.js');
                    function u(e) {
                        ...
                        var r = e.source, n = e.origin, u = (function (e) {
                            var r = void 0;
                            try {
                                r = (0, s.jsonParse)(e);
                            }
                        ...
                        if (u) {
                            ...
                            if (((0 !== u.sourceDomain.indexOf(i.CONSTANTS.MOCK_PROTOCOL) &&
                ...
                './src/drivers/receive/types.js': function (e, r, n) {
                    ...
                    var o, t = Object.assign ||
                        function (e) {
                            ...
                            return e;
                        }, i = n('./node_modules/zalgo-promise/src/index.js'), s = n('./node_modules/cross-domain-utils/src/index.js'), a = n('./src/conf/index.js'), c = n('./src/lib/index.js'), u = n('./src/drivers/send/index.js'), l = n('./src/drivers/listeners.js');
                        ...
                        (o[a.CONSTANTS.POST_MESSAGE_TYPE.REQUEST] = function (e, r, n) {
                            ...
                            return i.ZalgoPromise.all([
                                ...
                                i.ZalgoPromise.try(function () {
                                    ...
                                    var r = (0, c.stringifyError)(e).replace(/^Error: /, ''), n = e.code;
                                    return d({
                                        type: a.CONSTANTS.POST_MESSAGE_TYPE.RESPONSE,
                            ...
                            if (!(0, l.isResponseListenerErrored)(n.hash)) {
                                ...
                                if (!o)
                                    throw new Error('No handler found for post message response for message: ' +
                                        ...
                                        window.location.pathname);
                                if (!(0, s.matchDomain)(o.domain, r))
                                    throw new Error('Response origin ' + r + ' does not match domain ' + (0, s.stringifyDomainPattern)(o.domain));
                ...
                './src/drivers/send/index.js': function (e, r, n) {
                    ...
                    r.sendMessage = function (e, r, n) {
                        return i.ZalgoPromise.try(function () {
                            var u;
                            r = (function (e, r) {
                                var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}, i = (0, a.uniqueID)(), s = (0, a.getWindowType)(), c = (0, t.getDomain)(window);
                                return o({}, r, n, {
                                    sourceDomain: c,
                                    id: r.id || i,
                                    windowType: s
                            ...
                            if ((0, t.isWindowClosed)(e))
                                throw new Error('Window is closed');
                            a.log.debug('Running send message strategies', r);
                            var d = [], f = (0, a.jsonStringify)((((u = {})[s.CONSTANTS.WINDOW_PROPS.POSTROBOT] = r), u), null, 2);
                            return i.ZalgoPromise.map(Object.keys(c.SEND_MESSAGE_STRATEGIES), function (r) {
                                ...
                                var n = e.some(Boolean), o = r.type + ' ' + r.name + ' ' + (n ? 'success' : 'error') + ':\n  - ' + d.join('\n  - ') + '\n';
                                if ((a.log.debug(o), !n))
                                    throw new Error(o);
                            });
                        });
                    };
                    var t = n('./node_modules/cross-domain-utils/src/index.js'), i = n('./node_modules/zalgo-promise/src/index.js'), s = n('./src/conf/index.js'), a = n('./src/lib/index.js'), c = n('./src/drivers/send/strategies.js');
                },
                './src/drivers/send/strategies.js': function (e, r, n) {
                    'use strict';
                    (r.__esModule = !0), (r.SEND_MESSAGE_STRATEGIES = void 0);
                    var o = n('./node_modules/cross-domain-utils/src/index.js'), t = n('./src/conf/index.js'), i = (n('./src/lib/index.js'), (r.SEND_MESSAGE_STRATEGIES = {}));
                ...
                './src/interface.js': function (e, r, n) {
                    ...
                    Object.defineProperty(r, 'Promise', {
                        ...
                        (r.init = u);
                    var s = n('./src/lib/index.js'), a = n('./src/drivers/index.js'), c = n('./src/global.js');
                    function u() {
                    ...
                    var o = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator
                        ...
                        : function (e) {
                            return e && 'function' == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype
                                ? 'symbol'
                                : typeof e;
                        }, t = n('./src/conf/index.js'), i = n('./src/lib/util.js'), s = ['debug', 'info', 'warn', 'error'];
                    ...
                    var a = (r.log = {
                        ...
                        writeToPage: function (e, r) {
                            setTimeout(function () {
                                ...
                                var o = document.createElement('div'), t = new Date().toString().split(' ')[4], s = Array.prototype.slice
                                    .call(r)
                                    .map(function (e) {
                                    if ('string' == typeof e)
                                        return e;
                            ...
                            setTimeout(function () {
                                try {
                                    ...
                                    if ('disabled' === n || s.indexOf(e) < s.indexOf(n))
                                        return;
                                    if (((r = Array.prototype.slice.call(r)).unshift('' + window.location.host + window.location.pathname),
                                        r.unshift('::'),
                ...
                './src/lib/ready.js': function (e, r, n) {
                    ...
                    (r.__esModule = !0),
                        ...
                        (r.initOnReady = function () {
                            l(function (e) {
                                var r = e.source, n = e.origin, o = a.global.readyPromises.get(r) || new i.ZalgoPromise();
                        ...
                        (r.onChildWindowReady = function (e) {
                            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 5e3, n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 'Window', o = a.global.readyPromises.get(e);
                            return (o ||
                    ...
                    var o = n('./node_modules/cross-domain-safe-weakmap/src/index.js'), t = n('./node_modules/cross-domain-utils/src/index.js'), i = n('./node_modules/zalgo-promise/src/index.js'), s = n('./src/conf/index.js'), a = n('./src/global.js'), c = n('./src/lib/log.js'), u = n('./src/lib/util.js');
                    function l(e) {
                        a.global.on(s.CONSTANTS.POST_MESSAGE_NAMES.HELLO, { domain: s.CONSTANTS.WILDCARD }, function (r) {
                            var n = r.source, o = r.origin;
                ...
                './src/lib/serialize.js': function (e, r, n) {
                    ...
                    var t = n('./node_modules/cross-domain-safe-weakmap/src/index.js'), i = n('./node_modules/cross-domain-utils/src/index.js'), s = n('./node_modules/zalgo-promise/src/index.js'), a = n('./src/conf/index.js'), c = n('./src/global.js'), u = n('./src/lib/util.js'), l = n('./src/lib/log.js');
                    function d(e, r) {
                        return 'object' === (void 0 === e ? 'undefined' : o(e)) && null !== e && e.__type__ === r;
                    }
                    function f(e, r, n, o) {
                        var t = (0, u.uniqueID)(), i = c.global.methods.get(e);
                        return (i || ((i = {}), c.global.methods.set(e, i)),
                    ...
                    function m(e, r, n) {
                        function o() {
                            ...
                            return (l.log.debug('Call foreign method', n.__name__, o),
                                c.global
                                    .send(e, a.CONSTANTS.POST_MESSAGE_NAMES.METHOD, { id: n.__id__, name: n.__name__, args: o }, { domain: r, timeout: -1 })
                                    .then(function (e) {
                                    var r = e.data;
                    ...
                    (c.global.methods = c.global.methods || new t.WeakMap()),
                        (r.listenForMethods = (0, u.once)(function () {
                            c.global.on(a.CONSTANTS.POST_MESSAGE_NAMES.METHOD, { origin: a.CONSTANTS.WILDCARD }, function (e) {
                                var r = e.source, n = e.origin, o = e.data, t = c.global.methods.get(r);
                                if (!t)
                                ...
                                return (l.log.debug('Call local method', o.name, o.args),
                    ...
                    (r.stringifyError = function e(r) {
                        ...
                        try {
                            ...
                            if (r instanceof Error) {
                                var o = r && r.stack, t = r && r.message;
                                if (o && t)
                                    return -1 !== o.indexOf(t) ? o : t + '\n' + o;
                                if (o)
                                    return o;
                                if (t)
                                    return t;
                        ...
                        (r.addEventListener = function (e, r, n) {
                            return (e.addEventListener ? e.addEventListener(r, n) : e.attachEvent('on' + r, n),
                                {
                                    cancel: function () {
                        ...
                        (r.replaceObject = function e(r, n) {
                            ...
                            if ('object' !== (void 0 === r ? 'undefined' : o(r)) || null === r || Array.isArray(r)) {
                                if (!Array.isArray(r))
                                    throw new TypeError('Invalid type: ' + (void 0 === r ? 'undefined' : o(r)));
                                i = [];
                            }
                            else
                                i = {};
                            return (u(r, function (r, s) {
                                var a = n(r, s);
                                void 0 !== a
                                    ? (i[s] = a)
                        ...
                        (r.safeInterval = function (e, r) {
                            var n = void 0;
                            return ((n = setTimeout(function o() {
                                ;
                        ...
                        (r.jsonStringify = function (e, r, n) {
                            ...
                            try {
                                if (('{}' !== JSON.stringify({}) && ((o = Object.prototype.toJSON), delete Object.prototype.toJSON),
                                    '{}' !== JSON.stringify({})))
                                    throw new Error('Can not correctly serialize JSON objects');
                                if (('[]' !== JSON.stringify([]) && ((t = Array.prototype.toJSON), delete Array.prototype.toJSON),
                                    '[]' !== JSON.stringify([])))
                                    throw new Error('Can not correctly serialize JSON objects');
                            }
                            catch (e) {
                        ...
                        (r.needsGlobalMessagingForBrowser = function () {
                            return (!!(0, i.getUserAgent)(window).match(/MSIE|trident|edge\/12|edge\/13/i) ||
                                !s.CONFIG.ALLOW_POSTMESSAGE_POPUP);
                        });
                    var t = n('./node_modules/cross-domain-safe-weakmap/src/index.js'), i = n('./node_modules/cross-domain-utils/src/index.js'), s = n('./src/conf/index.js');
                    function a(e, r) {
                        for (var n = 0; n < e.length; n++)
                            r(e[n], n);
                    }
                ...
                './src/public/client.js': function (e, r, n) {
                    ...
                    var o = n('./node_modules/cross-domain-safe-weakmap/src/index.js'), t = n('./node_modules/zalgo-promise/src/index.js'), i = n('./node_modules/cross-domain-utils/src/index.js'), s = n('./src/conf/index.js'), a = n('./src/drivers/index.js'), c = n('./src/lib/index.js'), u = n('./src/global.js');
                    function l(e) {
                        return t.ZalgoPromise.try(function () {
                            if (!e.name)
                                throw new Error('Expected options.name');
                            var r = e.name, n = void 0, o = void 0;
                            ...
                            var m = !1, p = u.global.requestPromises.get(d);
                            ...
                            var g = t.ZalgoPromise.try(function () {
                                ...
                                return new t.ZalgoPromise(function (n, o) {
                                    ...
                                    if ((e.fireAndForget ||
                                        ...
                                        e.fireAndForget))
                                        return n();
                                    var c = s.CONFIG.ACK_TIMEOUT, l = e.timeout || s.CONFIG.RES_TIMEOUT, _ = 100;
                                    setTimeout(function n() {
                                        if (!m) {
                                            ...
                                            if (((c = Math.max(c - _, 0)), -1 !== l && (l = Math.max(l - _, 0)), t.ack)) {
                                                ...
                                                if (0 === c)
                                                    return o(new Error('No ack for postMessage ' +
                                                        r +
                                                        ' in ' +
                                                        (0, i.getDomain)() +
                                                        ' in ' +
                                                        ...
                                                        'ms'));
                                                if (0 === l)
                                                    return o(new Error('No response for postMessage ' +
                                                        r +
                                                        ' in ' +
                                                        (0, i.getDomain)() +
                                                        ' in ' +
                ...
                './src/public/server.js': function (e, r, n) {
                    ...
                    (r.listen = l),
                        (r.once = function (e) {
                            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments[2];
                            'function' == typeof r && ((n = r), (r = {})), (r = r || {}), (n = n || r.handler);
                            var o = r.errorHandler, t = new i.ZalgoPromise(function (t, i) {
                                ;
                                ((r = r || {}).name = e),
                                    (r.once = !0),
                    ...
                    var t = n('./node_modules/cross-domain-utils/src/index.js'), i = n('./node_modules/zalgo-promise/src/index.js'), s = n('./src/lib/index.js'), a = n('./src/drivers/index.js'), c = n('./src/conf/index.js'), u = n('./src/global.js');
                    function l(e) {
                        if (!e.name)
                            throw new Error('Expected options.name');
                        if (!e.handler)
                            throw new Error('Expected options.handler');
                        var r = e.name, n = e.window, i = e.domain, u = {
                            handler: e.handler,
    ...
    function (e, r, n) {
        ...
        var o = (function () {
            function e() { }
            return (Object.defineProperty(e, 'cookieUserId', {
                get: function () {
                    return ((function (e) {
