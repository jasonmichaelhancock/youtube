...
export { ComponentDidLoad, ComponentDidUnload, ComponentDidUpdate, ComponentWillLoad, ComponentWillUpdate, Config, EventEmitter, EventListenerEnable, FunctionalComponent } from '@stencil/core/dist/declarations';
 ...
 */
export declare enum BearerRootComponentRoleEnum {
    Display = "display",
    Action = "action"
}
